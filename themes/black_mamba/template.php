<?php
// $Id: template.php,v 1.2 2009/09/19 07:03:49 giorgio79 Exp $ 
/**
...
function phptemplate_preprocess_page(&$vars) {
  ...
  $vars['closure'] .= '<div id="legal-notice">Powered by <strong>Drupal</strong>, an open source content management system.</div>';
}
...
function black_mamba_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
