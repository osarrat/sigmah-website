...
?>
	...
	<div class="formulaire_sinscrire">
	  <?php if ($use_form): ?>   
		<?php print $form; ?>
	  <?php elseif ($subscription_link): ?>
		<?php print $subscription_link; ?>
	  <?php endif; ?>
	</div>
  <?php if ($use_issue_link && $newsletter_link): ?>
    <div class="issues-link suffix"><?php print $newsletter_link; ?></div>
  <?php endif; ?>

  <?php if ($use_issue_list && $issue_list): ?>
    <div class="issues-list suffix"><?php print $issue_list; ?></div>
  <?php endif; ?>
