...
if ( utf8_strtolower( $f_type ) == 'id' ) {
	echo '<ShortName>SigmahIssues IssueId</ShortName>';
	echo '<Description>SigmahIssues Issue Id</Description>';
	echo '<InputEncoding>UTF-8</InputEncoding>';
} else {
	echo '<ShortName>SigmahIssues Search</ShortName>';
	echo '<Description>SigmahIssues Text Search</Description>';
	echo '<InputEncoding>UTF-8</InputEncoding>';
}
?>
